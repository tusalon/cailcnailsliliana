...
const urlsToCache = [
  ...
  '/cailcnailsliliana/utils/push-config.js',
  '/cailcnailsliliana/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/cailcnailsliliana/icons/icon-192x192.png',
    badge: '/cailcnailsliliana/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/cailcnailsliliana/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/cailcnailsliliana/admin.html';
  event.waitUntil(
